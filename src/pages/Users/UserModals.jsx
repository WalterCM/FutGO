        ...
        <>
            ...
            >
                <div style={{ textAlign: 'center', padding: '1rem' }}>
                    ...
                    <h3 style={{ marginBottom: '1rem' }}>Corregir Identidad</h3>
                    <p style={{ color: 'var(--text-dim)', marginBottom: '1.5rem' }}>Estás editando el nombre de este jugador.</p>

                    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '1rem', borderRadius: '12px', marginBottom: '1.5rem', textAlign: 'left' }}>
                        <label style={{ fontSize: '0.8rem', color: 'var(--text-dim)', display: 'block', marginBottom: '0.5rem' }}>Nombre:</label>
                        <input
                            type='text'
                            autoFocus
            ...
            >
                <div style={{ textAlign: 'center', padding: '1rem' }}>
                    ...
                    <h3 style={{ marginBottom: '1rem' }}>Confirmar Cambio de Rol</h3>
            ...
            >
                <div style={{ textAlign: 'center', padding: '1rem' }}>
                    ...
                    <h3 style={{ marginBottom: '1rem', color: 'var(--danger)' }}>Eliminar Usuario</h3>
                    <p style={{ marginBottom: '1.5rem', lineHeight: '1.5' }}>
                        ¿Estás seguro de eliminar a <b>{deleteConfirm.user?.full_name}</b>?
                        <br />
                        <span style={{ fontSize: '0.9rem', color: 'var(--text-dim)' }}>
                            Esta acción eliminará todos sus datos y enrollments. No se puede deshacer.
                        </span>
                    </p>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                        ...
                        <Button
                            variant='danger'
                            onClick={() => onDeleteUser(deleteConfirm.user.id)}
                            loading={actionLoading === deleteConfirm.user?.id + 'delete'}
                        >
                            Eliminar
                        </Button>
                    </div>
